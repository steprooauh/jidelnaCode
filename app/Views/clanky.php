            ...
            <div class="col-lg-6 col-12 paddingmobil">
                <div class="ratio ratio-1x1 position-relative overflow-hidden rounded kartavelka">
                    <div class="position-absolute top-0 start-0 w-100 h-100"
                        style="background-size: cover;background-position:center;background-image: url(<?= base_url('img/smazak.jpeg'); ?>)">
                        <div
                            ...
                            <a class="mt-auto fw-bold fs-2 text-white text-decoration-none"
                                href="<?= base_url('https://www.toprecepty.cz/recept/37512-smazeny-syr-smazak/'); ?>"
                ...
                <div class="row">
                    <div class="col-6 pb-4 kartamala">
                        <div class="ratio ratio-1x1 position-relative overflow-hidden rounded">
                            <div class="position-absolute top-0 start-0 w-100 h-100"
                                style="background-size: cover;background-position:center;background-image: url(<?= base_url('img/prsty.jpg'); ?>)">
                                <div
                                    class="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50
                                            d-flex flex-column justify-content-center align-items-start text-white text-left p-3">
                                    <a class="mt-auto fw-bold fs-2 text-white text-decoration-none"
                                        href="<?= base_url('https://www.toprecepty.cz/tipy-triky/rybi-prsty-co-obsahuji-a-jak-je-pripravit/'); ?>"
                    ...
                    <div class="col-6 kartamala">
                        <div class="ratio ratio-1x1 position-relative overflow-hidden rounded">
                            <div class="position-absolute top-0 start-0 w-100 h-100"
                                style="background-size: cover;background-position:center;background-image: url(<?= base_url('img/livance.jpg'); ?>)">
                                <div
                                    class="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50
                                            d-flex flex-column justify-content-center align-items-start text-white text-left p-3">
                                    <a class="mt-auto fw-bold fs-2 text-white text-decoration-none"
                                        href="<?= base_url('https://www.toprecepty.cz/recept/26018-extra-rychle-livance/'); ?>"
                    ...
                    <div class="col-6 kartamala">
                        <div class="ratio ratio-1x1 position-relative overflow-hidden rounded">
                            <div class="position-absolute top-0 start-0 w-100 h-100"
                                style="background-size: cover;background-position:center;background-image: url(<?= base_url('img/svickova.jpeg'); ?>)">
                                <div
                                    class="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50
                                            d-flex flex-column justify-content-center align-items-start text-white text-left p-3">
                                    <a class="mt-auto fw-bold fs-2 text-white text-decoration-none"
                                        href="<?= base_url('https://www.toprecepty.cz/recept/2856-svickova-na-smetane/'); ?>"
                    ...
                    <div class="col-6 kartamala">
                        <div class="ratio ratio-1x1 position-relative overflow-hidden rounded">
                            <div class="position-absolute top-0 start-0 w-100 h-100"
                                style="background-size: cover;background-position:center;background-image: url(<?= base_url('img/testoviny.jpg'); ?>)">
                                <div
                                    class="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50
                                            d-flex flex-column justify-content-center align-items-start text-white text-left p-3">
                                    <a class="mt-auto fw-bold fs-2 text-white text-decoration-none"
                                        href="<?= base_url('https://www.toprecepty.cz/recept/1621-testovinovy-salat/'); ?>"
